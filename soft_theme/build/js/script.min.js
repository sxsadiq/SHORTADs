...
+(function (e) {
  ...
  b.prototype.close = function (j) {
    ...
    e.support.transition && h.hasClass("fade")
      ? h.one("bsTransitionEnd", f).emulateTransitionEnd(b.TRANSITION_DURATION)
      : f();
  };
  function c(f) {
    return this.each(function () {
...
+(function (d) {
  ...
  d(document)
    .on("click.bs.button.data-api", '[data-toggle^="button"]', function (g) {
    ...
    .on(
      ...
      function (f) {
        d(f.target)
          .closest(".btn")
          .toggleClass("focus", /^focus(in)?$/.test(f.type));
      }
    );
})(jQuery);
+(function (c) {
  var d = function (g, f) {
    ...
    this.options.keyboard &&
      this.$element.on("keydown.bs.carousel", c.proxy(this.keydown, this));
    this.options.pause == "hover" &&
      !("ontouchstart" in document.documentElement) &&
      this.$element
        .on("mouseenter.bs.carousel", c.proxy(this.pause, this))
        .on("mouseleave.bs.carousel", c.proxy(this.cycle, this));
  };
  d.VERSION = "3.4.1";
  ...
  d.prototype.getItemForDirection = function (j, i) {
    ...
    var g =
      (j == "prev" && f === 0) || (j == "next" && f == this.$items.length - 1);
...
+(function (d) {
  ...
  e.prototype.show = function () {
    ...
    this.$element
      .one("bsTransitionEnd", d.proxy(f, this))
...
+(function (h) {
  ...
  h(document)
    ...
    .on("click.bs.dropdown.data-api", b, a.prototype.toggle)
    .on("keydown.bs.dropdown.data-api", b, a.prototype.keydown)
...
+(function (d) {
  ...
  b.prototype.backdrop = function (i) {
    ...
    if (this.isShown && this.options.backdrop) {
      ...
      this.$backdrop = d(document.createElement("div"))
  ...
  b.prototype.setScrollbar = function () {
    ...
    if (this.bodyIsOverflowing) {
      this.$body.css("padding-right", e + f);
      d(this.fixedContent).each(function (h, i) {
        var g = i.style.paddingRight;
        var j = d(i).css("padding-right");
        d(i)
          .data("padding-right", g)
          .css("padding-right", parseFloat(j) + f + "px");
      });
    }
  };
  b.prototype.resetScrollbar = function () {
    this.$body.css("padding-right", this.originalBodyPad);
    d(this.fixedContent).each(function (e, f) {
      var g = d(f).data("padding-right");
  ...
  d(document).on(
    ...
    function (k) {
      ...
      var h = f.data("bs.modal")
        ? "toggle"
        : d.extend({ remote: !/#/.test(g) && g }, f.data(), j.data());
      if (j.is("a")) {
        k.preventDefault();
      }
...
+(function (c) {
  ...
  function b(m, o) {
    var r = m.nodeName.toLowerCase();
    if (c.inArray(r, o) !== -1) {
      if (c.inArray(r, j) !== -1) {
        return Boolean(m.nodeValue.match(e) || m.nodeValue.match(f));
      }
      return true;
    }
    var p = c(o).filter(function (s, t) {
  ...
  function g(y, u, z) {
    ...
    for (var s = 0, t = n.length; s < t; s++) {
      ...
      var p = c.map(o.attributes, function (A) {
        return A;
      });
      var w = [].concat(u["*"] || [], u[m] || []);
      for (var r = 0, q = p.length; r < q; r++) {
        if (!b(p[r], w)) {
          o.removeAttribute(p[r].nodeName);
        }
      }
    }
  ...
  i.prototype.init = function (s, q, o) {
    this.enabled = true;
    this.type = s;
    this.$element = c(q);
    ...
    for (var p = r.length; p--; ) {
      ...
      if (n == "click") {
        ...
        if (n != "manual") {
          var t = n == "hover" ? "mouseenter" : "focusin";
  ...
  i.prototype.getOptions = function (m) {
    var n = this.$element.data();
    for (var o in n) {
      if (n.hasOwnProperty(o) && c.inArray(o, h) !== -1) {
        delete n[o];
      }
    }
    m = c.extend({}, this.getDefaults(), n, m);
    if (m.delay && typeof m.delay == "number") {
      m.delay = { show: m.delay, hide: m.delay };
    }
    if (m.sanitize) {
      m.template = g(m.template, m.whiteList, m.sanitizeFn);
    }
    return m;
  };
  i.prototype.getDelegateOptions = function () {
    ...
    this._options &&
      c.each(this._options, function (o, p) {
        if (n[o] != p) {
          m[o] = p;
        }
      });
  ...
  i.prototype.enter = function (n) {
    var m =
      n instanceof this.constructor
        ? n
        : c(n.currentTarget).data("bs." + this.type);
    if (!m) {
      m = new this.constructor(n.currentTarget, this.getDelegateOptions());
      c(n.currentTarget).data("bs." + this.type, m);
    }
    if (n instanceof c.Event) {
      m.inState[n.type == "focusin" ? "focus" : "hover"] = true;
    }
    if (m.tip().hasClass("in") || m.hoverState == "in") {
      m.hoverState = "in";
      return;
    }
    clearTimeout(m.timeout);
    m.hoverState = "in";
    if (!m.options.delay || !m.options.delay.show) {
      return m.show();
    }
  ...
  i.prototype.leave = function (n) {
    ...
    if (n instanceof c.Event) {
      m.inState[n.type == "focusout" ? "focus" : "hover"] = false;
    }
    if (m.isInStateTrue()) {
      return;
    }
    clearTimeout(m.timeout);
    m.hoverState = "out";
    if (!m.options.delay || !m.options.delay.hide) {
      return m.hide();
    }
    m.timeout = setTimeout(function () {
      if (m.hoverState == "out") {
  ...
  i.prototype.show = function () {
    var v = c.Event("show.bs." + this.type);
    if (this.hasContent() && this.enabled) {
      ...
      this.options.container
        ? s.appendTo(c(document).find(this.options.container))
      ...
      if (A) {
        ...
        r =
          r == "bottom" && x.bottom + t > y.bottom
            ? "top"
            : r == "top" && x.top - t < y.top
            ? "bottom"
            : r == "right" && x.right + m > y.width
            ? "left"
            : r == "left" && x.left - m < y.left
            ? "right"
            : r;
  ...
  i.prototype.applyPlacement = function (r, s) {
    var t = this.tip();
    ...
    c.offset.setOffset(
      ...
      c.extend(
        {
          using: function (z) {
            t.css({ top: Math.round(z.top), left: Math.round(z.left) });
          },
        },
        r
      ),
  ...
  i.prototype.replaceArrow = function (o, m, n) {
    this.arrow()
      .css(n ? "left" : "top", 50 * (1 - o / m) + "%")
      .css(n ? "top" : "left", "");
  };
  i.prototype.setContent = function () {
    ...
    if (this.options.html) {
      if (this.options.sanitize) {
        m = g(m, this.options.whiteList, this.options.sanitizeFn);
      }
      n.find(".tooltip-inner").html(m);
    } else {
      n.find(".tooltip-inner").text(m);
    }
    n.removeClass("fade in top bottom left right");
  };
  i.prototype.hide = function (q) {
    var n = this;
    var p = c(this.$tip);
    ...
    c.support.transition && p.hasClass("fade")
      ? p.one("bsTransitionEnd", m).emulateTransitionEnd(i.TRANSITION_DURATION)
      : m();
    this.hoverState = null;
    return this;
  };
  i.prototype.fixTitle = function () {
    var m = this.$element;
    if (m.attr("title") || typeof m.attr("data-original-title") != "string") {
      m.attr("data-original-title", m.attr("title") || "").attr("title", "");
    }
  };
  i.prototype.hasContent = function () {
    return this.getTitle();
  };
  i.prototype.getPosition = function (o) {
    o = o || this.$element;
    var q = o[0];
  ...
  i.prototype.getCalculatedOffset = function (m, p, n, o) {
    return m == "bottom"
      ? { top: p.top + p.height, left: p.left + p.width / 2 - n / 2 }
      : m == "top"
      ? { top: p.top - o, left: p.left + p.width / 2 - n / 2 }
      : m == "left"
      ? { top: p.top + p.height / 2 - o / 2, left: p.left - n }
      : { top: p.top + p.height / 2 - o / 2, left: p.left + p.width };
  };
  i.prototype.getViewportAdjustedDelta = function (p, s, m, r) {
    var u = { top: 0, left: 0 };
    if (!this.$viewport) {
      return u;
    }
    ...
    if (/right|left/.test(p)) {
      var v = s.top - o - t.scroll;
      var q = s.top + o - t.scroll + r;
      if (v < t.top) {
        u.top = t.top - v;
      } else {
        if (q > t.top + t.height) {
          u.top = t.top + t.height - q;
        }
      }
    } else {
      var w = s.left - o;
  ...
  i.prototype.getTitle = function () {
    ...
    p =
      ...
      (typeof n.title == "function" ? n.title.call(m[0]) : n.title);
    return p;
  };
  i.prototype.getUID = function (m) {
    do {
  ...
  i.prototype.toggle = function (n) {
    var m = this;
    if (n) {
      m = c(n.currentTarget).data("bs." + this.type);
      if (!m) {
        m = new this.constructor(n.currentTarget, this.getDelegateOptions());
        c(n.currentTarget).data("bs." + this.type, m);
      }
    ...
    if (n) {
      ...
      m.tip().hasClass("in") ? m.leave(m) : m.enter(m);
    }
  };
  i.prototype.destroy = function () {
    ...
    this.hide(function () {
      m.$element.off("." + m.type).removeData("bs." + m.type);
      if (m.$tip) {
        m.$tip.detach();
      }
      m.$tip = null;
  ...
  i.prototype.sanitizeHtml = function (m) {
    return g(m, this.options.whiteList, this.options.sanitizeFn);
  };
  function k(m) {
    return this.each(function () {
      var p = c(this);
      ...
      if (!o && /destroy|hide/.test(m)) {
        return;
      }
      if (!o) {
        p.data("bs.tooltip", (o = new i(this, n)));
      }
      if (typeof m == "string") {
        o[m]();
      }
...
+(function (d) {
  ...
  c.prototype.setContent = function () {
    ...
    if (this.options.html) {
      var h = typeof e;
      if (this.options.sanitize) {
        f = this.sanitizeHtml(f);
        if (h === "string") {
          e = this.sanitizeHtml(e);
        }
      }
      g.find(".popover-title").html(f);
      g.find(".popover-content")
        .children()
        .detach()
        .end()
        [h === "string" ? "html" : "append"](e);
    } else {
      g.find(".popover-title").text(f);
  ...
  c.prototype.getContent = function () {
    ...
    return (
      e.attr("data-content") ||
      (typeof f.content == "function" ? f.content.call(e[0]) : f.content)
    );
  };
  ...
  c.prototype.refresh = function () {
    ...
    this.$body
      ...
      .map(function () {
        ...
        var j = /^#./.test(h) && d(h);
        return (
          (j && j.length && j.is(":visible") && [[j[e]().top + f, h]]) || null
        );
      })
      .sort(function (i, h) {
        return i[0] - h[0];
...
+(function (d) {
  ...
  b.prototype.show = function () {
    ...
    this.activate(f, f.parent(), function () {
      j.trigger({ type: "hidden.bs.tab", relatedTarget: l[0] });
  ...
  b.prototype.activate = function (h, g, k) {
    ...
    var j =
      ...
      ((f.length && f.hasClass("fade")) || !!g.find("> .fade").length);
    function i() {
    ...
    f.length && j
      ? f.one("bsTransitionEnd", i).emulateTransitionEnd(b.TRANSITION_DURATION)
      : i();
    f.removeClass("in");
  };
  function c(f) {
  ...
  var c = function (f, e) {
    ...
    var g =
      this.options.target === c.DEFAULTS.target
        ...
        : d(document).find(this.options.target);
    this.$target = g
      .on("scroll.bs.affix.data-api", d.proxy(this.checkPosition, this))
      .on(
        "click.bs.affix.data-api",
        d.proxy(this.checkPositionWithEventLoop, this)
      );
    this.$element = d(f);
    this.affixed = null;
    this.unpin = null;
  ...
  c.prototype.checkPosition = function () {
    ...
    if (this.affixed != g) {
      ...
      this.$element
        .removeClass(c.RESET)
        .addClass(m)
        .trigger(m.replace("affix", "affixed") + ".bs.affix");
    }
    if (g == "bottom") {
...
function fixHeight() {
  var a = $("#mainNav").outerHeight();
  $("#frame").attr("height", $(window).height() - 0 - a + "px");
}
$(window)
  .resize(function () {
    fixHeight();
...
$(document).ready(function () {
  $(".testimonials").owlCarousel({ items: 1, margin: 10, loop: true });
  $(".advertising-rates > ul.nav-tabs li:first-child").addClass("active");
  $(".payout-rates > ul.nav-tabs li:first-child").addClass("active");
  $(".advertising-rates > div.tab-content div.tab-pane:first-child").addClass(
    "active"
  );
...
$("#contact-form").submit(function (f) {
  ...
  $.ajax({
    ...
    beforeSend: function (e) {
      c.attr("disabled", true).html('<i class="fa fa-spinner fa-spin"></i>');
      $('<div class="loader"></div>').insertAfter(a);
    },
    success: function (e, g, i) {
      if (e.status === "success") {
        ...
        var h =
          ...
          e.message +
          "</div>";
        $("#contact .contact-result").html(h).slideDown();
      } else {
        a.slideUp();
        var h =
    ...
    error: function (h, e, g) {
      alert("An error occured: " + h.status + " " + h.statusText);
    },
...
$("a.popup").on("click", function (h) {
  ...
  var c = 575,
    ...
    f = ($(window).height() - a) / 2,
    b = this.href,
    d = "status=1,width=" + c + ",height=" + a + ",top=" + f + ",left=" + g;
  window.open(b, "share", d);
});
var captchaShort;
var captchaContact;
var captchaSignin;
...
var onloadRecaptchaCallback = function () {
  ...
  if (app_vars.captcha_type === "invisible-recaptcha") {
    ...
    if (
      ...
      $("#forgotpassword-form").submit(function (a) {
...
if (go_popup.length) {
  $(document).one("click.adLinkFly.goPopupClick", function (a) {
    go_popup.submit();
  });
  go_popup.one("submit.adLinkFly.goPopupSubmit", function (f) {
    var d = screen.height - 150;
    var b = screen.width - 150;
    var g = Number(screen.width / 2 - b / 2);
    var a = Number(screen.height / 2 - d / 2);
    var c = window.open(
      "about:blank",
      "Popup_Window",
...
function checkAdblockUser() {
  ...
  var b = $("#ad-banner");
  if (
    b.filter(":visible").length === 0 ||
    b.filter(":hidden").length > 0 ||
    b.height() === 0
  ) {
    ...
    if (app_vars.force_disable_adblock === "1") {
      var a =
        ...
        "</div>";
      $("#link-view").replaceWith(a);
      $(".banner-page a.get-link").replaceWith(a);
      $(".interstitial-page div.skip-ad").replaceWith(a);
    }
  }
}
function checkAdsbypasserUser() {
  ...
  var a = ["AdsBypasser", "SafeBrowse"];
  var b = document.title.split(" ").splice(-1)[0];
  document.cookie = "ab=2; path=/";
  if (a.indexOf(b) >= 0) {
    document.cookie = "ab=1; path=/";
  }
      ...
      var b,
        ...
        c = function c() {
          try {
            ...
            navigator.cookieEnabled ? a() : e();
          }
        };
      window.webkitRequestFileSystem
        ? webkitRequestFileSystem(0, 0, e, a)
        : "MozAppearance" in document.documentElement.style
        ? ((b = indexedDB.open("test")), (b.onerror = a), (b.onsuccess = e))
...
$(counter_start_object).on(
  ...
  function (c) {
    if (ad_type === "banner") {
      var d = $("#timer");
      window.setTimeout(function () {
        var f = app_vars.counter_value * 1000,
          g = 1000,
          e;
...
checkPrivateMode();
$("#go-link").one("submit.adLinkFly.counterSubmit", function (c) {
  c.preventDefault();
  var b = $(this);
  if (!b.hasClass("go-link")) {
    return;
  }
  var a = b.find("button");
  $.ajax({
    ...
    success: function (d, e, f) {
      if (d.url) {
        ...
        if (ad_type === "interstitial") {
          $(".skip-ad a").attr("href", d.url).removeAttr("onclick");
        }
      } else {
        alert(d.message);
      }
    ...
    error: function (f, d, e) {
      console.log("An error occured: " + f.status + " " + f.statusText);
    },
...
$(document).ready(function () {
  ...
  if (e.substr(-1) === "#") {
    history.pushState("", document.title, e.substr(0, e.length - 1));
  }
  ...
  $(".sidebar-menu a")
    ...
    .addClass("active");
  function d() {
    var f = $("header.main-header").outerHeight();
    $("#frame").attr("height", $(window).height() - 0 - f + "px");
  }
  $(window)
    .resize(function () {
      d();
  ...
  function b() {
    var f = 0;
    $("input[id^=campaign-items-][id$=-purchase]").each(function (h, i) {
      var j = $(i).val();
      f += j * 1000;
    });
    $("#total-visitors").text(f);
    var g = 0;
    $("input[id^=campaign-items-][id$=-purchase]").each(function (h, i) {
      var j = $(i).data("advertiser_price");
      g += j * $(i).val();
    });
    $("#total-price").text(g.toFixed(2).toLocaleString(app_vars.language));
  }
  b();
  ...
  $(window)
    ...
    .resize();
  $("button.shorten-button").click(function (f) {
    f.preventDefault();
    $(".box-short").toggle("fast");
  });
});
$('#form-settings a[data-toggle="tab"]').on("shown.bs.tab", function (a) {
  var b = $(a.target).attr("href").substr(1);
  localStorage.setItem("settings_selectedTab", b);
});
...
$(".shorten-member #shorten").on(
  ...
  function (d) {
    d.preventDefault();
    var c = $(this);
    var f = c.closest(".box-short");
    var b = c.find("button.btn-submit");
    var a = b.html();
    $.ajax({
      dataType: "json",
      type: "POST",
      ...
      data: c.serialize(),
      beforeSend: function (e) {
        b.attr("disabled", "disabled").html(
          '<i class="fa fa-spinner fa-spin"></i>'
        );
        $(
          '<div class="overlay"><i class="fa fa-refresh fa-spin"></i></div>'
        ).insertAfter(f.find(".box-body"));
      },
      success: function (e, g, j) {
        if (e.url) {
          var h =
          ...
          $(".shorten.add-link-result").html(h).slideDown();
      ...
      complete: function (g, e) {
        f.find(".overlay").remove();
        b.removeAttr("disabled").html(a);
      },
    });
  }
);
$(".shorten #shorten").on("submit.adLinkFly.homeShortLinkForm", function (d) {
  d.preventDefault();
  if (
    app_vars.user_id === null &&
  ...
  $.ajax({
    ...
    beforeSend: function (e) {
      ...
      $('<div class="shorten loader"></div>').insertAfter(c);
    },
    success: function (e, f, i) {
      if (e.url) {
        c.slideUp();
        var g =
          '<div class="form-group"><div class="input-group"><input class="form-control input-lg" value="' +
        ...
        $(".shorten.add-link-result").html(g).slideDown();
      } else {
        c.slideUp();
        var h =
          '<div class="form-group"><div class="input-group"><input class="form-control input-lg" value="' +
        ...
        $(".shorten.add-link-result").html(h).slideDown();
        if (typeof window.captchaShort_captcha_img_audioObj !== "undefined") {
          captchaShort_captcha_img_audioObj.refresh();
        }
        document.getElementById("captchaShort_captcha_img").src =
          app_vars.current_url +
          "securimage/show?namespace=captchaShort&" +
          Math.random();
      }
    },
    error: function (g, e, f) {
      alert("An error occured: " + g.status + " " + g.statusText);
    },
...
$("section.shorten").on("click", ".reshort", function (a) {
...
clipboard.on("success", function (a) {
  setTooltip(a.trigger, app_vars.copied);
});
function setTooltip(a, b) {
